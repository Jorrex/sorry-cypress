...
export type CreateDiscordHookMutationVariables = Exact<{
  input: CreateDiscordHookInput;
}>;


export type CreateDiscordHookMutation = { __typename?: 'Mutation', createDiscordHook: { __typename?: 'DiscordHook', hookId: string, hookType: any, url: string, hookEvents: Array<string>, discordResultFilter: any | null } };
...
export type UpdateDiscordHookMutationVariables = Exact<{
  input: UpdateDiscordHookInput;
}>;


export type UpdateDiscordHookMutation = { __typename?: 'Mutation', updateDiscordHook: { __typename?: 'DiscordHook', hookId: string } };
...
export const CreateDiscordHookDocument = gql`
    mutation createDiscordHook($input: CreateDiscordHookInput!) {
  createDiscordHook(input: $input) {
    hookId
    hookType
    url
    hookEvents
    ...
    `;
export type CreateDiscordHookMutationFn = Apollo.MutationFunction<CreateDiscordHookMutation, CreateDiscordHookMutationVariables>;

/**
 * __useCreateDiscordHookMutation__
 *
 * To run a mutation, you first call `useCreateDiscordHookMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateDiscordHookMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createDiscordHookMutation, { data, loading, error }] = useCreateDiscordHookMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateDiscordHookMutation(baseOptions?: Apollo.MutationHookOptions<CreateDiscordHookMutation, CreateDiscordHookMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateDiscordHookMutation, CreateDiscordHookMutationVariables>(CreateDiscordHookDocument, options);
      }
export type CreateDiscordHookMutationHookResult = ReturnType<typeof useCreateDiscordHookMutation>;
export type CreateDiscordHookMutationResult = Apollo.MutationResult<CreateDiscordHookMutation>;
export type CreateDiscordHookMutationOptions = Apollo.BaseMutationOptions<CreateDiscordHookMutation, CreateDiscordHookMutationVariables>;
...
export const UpdateDiscordHookDocument = gql`
    mutation updateDiscordHook($input: UpdateDiscordHookInput!) {
  updateDiscordHook(input: $input) {
    hookId
  }
}
    `;
export type UpdateDiscordHookMutationFn = Apollo.MutationFunction<UpdateDiscordHookMutation, UpdateDiscordHookMutationVariables>;

/**
 * __useUpdateDiscordHookMutation__
 *
 * To run a mutation, you first call `useUpdateDiscordHookMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateDiscordHookMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateDiscordHookMutation, { data, loading, error }] = useUpdateDiscordHookMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateDiscordHookMutation(baseOptions?: Apollo.MutationHookOptions<UpdateDiscordHookMutation, UpdateDiscordHookMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateDiscordHookMutation, UpdateDiscordHookMutationVariables>(UpdateDiscordHookDocument, options);
      }
export type UpdateDiscordHookMutationHookResult = ReturnType<typeof useUpdateDiscordHookMutation>;
export type UpdateDiscordHookMutationResult = Apollo.MutationResult<UpdateDiscordHookMutation>;
export type UpdateDiscordHookMutationOptions = Apollo.BaseMutationOptions<UpdateDiscordHookMutation, UpdateDiscordHookMutationVariables>;
